...
# 26 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_rcc_ex.c" 2
# 2515 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_rcc_ex.c"
HAL_StatusTypeDef HAL_RCCEx_PeriphCLKConfig(RCC_PeriphCLKInitTypeDef *PeriphClkInit)
{
     ...
     (((PeriphClkInit->PeriphClockSelection) & 0x00000004U) == 0x00000004U))
  {
    ...
    (((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->PLLI2SCFGR = ((PeriphClkInit->PLLI2S.PLLI2SM) | ((PeriphClkInit->PLLI2S.PLLI2SN) << (6U)) | ((PeriphClkInit->PLLI2S.PLLI2SR) << (28U))));
...
void HAL_RCCEx_GetPeriphCLKConfig(RCC_PeriphCLKInitTypeDef *PeriphClkInit)
{
  ...
  PeriphClkInit->PLLI2S.PLLI2SM = (uint32_t)(((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->PLLI2SCFGR & (0x3FUL << (0U)));
      ...
      case 0x00000000U:
        {
          ...
          if((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->PLLCFGR & (0x1UL << (22U))) == (0x1UL << (22U)))
          {
            ...
            vcoinput = (uint32_t)(((uint32_t)8000000U) / (uint32_t)(((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->PLLI2SCFGR & (0x3FUL << (0U))));
          }
          else
          {
...
# 2860 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_rcc_ex.c"
  (((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->PLLI2SCFGR = ((PLLI2SInit->PLLI2SM) | ((PLLI2SInit->PLLI2SN) << (6U)) | ((PLLI2SInit->PLLI2SR) << (28U))));
...
# 3265 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_rcc_ex.c"
  ((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->PLLI2SCFGR = (0x10UL << (0U)) | (0x040UL << (6U)) | (0x080UL << (6U)) | (0x2UL << (28U));
