# 1 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_ioreq.c"
...
#define DEBUG 1
# 1 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_ioreq.c"
# 21 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_ioreq.c"
...
# 30 "../Middlewares/ST/STM32_USB_Host_Library/Core/Inc/usbh_ioreq.h" 2
...
# 1 "../Middlewares/ST/STM32_USB_Host_Library/Core/Inc/usbh_core.h" 1
# 30 "../Middlewares/ST/STM32_USB_Host_Library/Core/Inc/usbh_pipes.h" 2
...
USBH_StatusTypeDef USBH_IsocSendData(USBH_HandleTypeDef *phost,
                                     ...
                                     uint32_t length,
                                     uint8_t pipe_num);
# 22 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_ioreq.c" 2
# 92 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_ioreq.c"
USBH_StatusTypeDef USBH_CtlSendSetup(USBH_HandleTypeDef *phost,
                                     uint8_t *buff,
                                     uint8_t pipe_num)
{
...
# 118 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_ioreq.c"
USBH_StatusTypeDef USBH_CtlSendData(USBH_HandleTypeDef *phost,
                                    uint8_t *buff,
                                    uint16_t length,
                                    uint8_t pipe_num,
...
# 151 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_ioreq.c"
USBH_StatusTypeDef USBH_CtlReceiveData(USBH_HandleTypeDef *phost,
                                       uint8_t *buff,
                                       uint16_t length,
                                       uint8_t pipe_num)
...
# 178 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_ioreq.c"
USBH_StatusTypeDef USBH_BulkSendData(USBH_HandleTypeDef *phost,
                                     uint8_t *buff,
                                     uint16_t length,
                                     uint8_t pipe_num,
...
# 210 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_ioreq.c"
USBH_StatusTypeDef USBH_BulkReceiveData(USBH_HandleTypeDef *phost,
                                        uint8_t *buff,
                                        uint16_t length,
                                        uint8_t pipe_num)
...
# 236 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_ioreq.c"
USBH_StatusTypeDef USBH_InterruptReceiveData(USBH_HandleTypeDef *phost,
                                             uint8_t *buff,
                                             uint8_t length,
                                             uint8_t pipe_num)
...
# 262 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_ioreq.c"
USBH_StatusTypeDef USBH_InterruptSendData(USBH_HandleTypeDef *phost,
                                          uint8_t *buff,
                                          uint8_t length,
                                          uint8_t pipe_num)
...
# 288 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_ioreq.c"
USBH_StatusTypeDef USBH_IsocReceiveData(USBH_HandleTypeDef *phost,
                                        uint8_t *buff,
                                        uint32_t length,
                                        uint8_t pipe_num)
...
# 315 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_ioreq.c"
USBH_StatusTypeDef USBH_IsocSendData(USBH_HandleTypeDef *phost,
                                     uint8_t *buff,
                                     uint32_t length,
                                     uint8_t pipe_num)
