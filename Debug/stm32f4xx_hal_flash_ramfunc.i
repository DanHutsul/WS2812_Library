...
# 50 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_flash_ramfunc.c" 2
...
__attribute__((section(".RamFunc"))) HAL_StatusTypeDef HAL_FLASHEx_StopFlashInterfaceClk(void)
{
  ...
  ((((PWR_TypeDef *) (0x40000000UL + 0x7000UL))->CR) |= ((0x1UL << (21U))));
...
__attribute__((section(".RamFunc"))) HAL_StatusTypeDef HAL_FLASHEx_EnableFlashSleepMode(void)
{
  ...
  ((((PWR_TypeDef *) (0x40000000UL + 0x7000UL))->CR) |= ((0x1UL << (20U))));
