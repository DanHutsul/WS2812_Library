# 1 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_i2s_ex.c"
...
#define DEBUG 1
# 1 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_i2s_ex.c"
# 91 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_i2s_ex.c"
...
# 92 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_i2s_ex.c" 2
# 110 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_i2s_ex.c"
typedef enum
{
  I2S_USE_I2S = 0x00U,
  I2S_USE_I2SEXT = 0x01U,
} I2S_UseTypeDef;
# 125 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_i2s_ex.c"
...
# 205 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_i2s_ex.c"
HAL_StatusTypeDef HAL_I2SEx_TransmitReceive(I2S_HandleTypeDef *hi2s, uint16_t *pTxData, uint16_t *pRxData,
                                            uint16_t Size, uint32_t Timeout)
{
  uint32_t tmp1 = 0U;
  ...
  if ((pTxData == 
# 217 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_i2s_ex.c" 3 4
                 ((void *)0)
# 217 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_i2s_ex.c"
                     ) || (pRxData == 
# 217 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_i2s_ex.c" 3 4
                                      ((void *)0)
# 217 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_i2s_ex.c"
  ...
  tmp1 = hi2s->Instance->I2SCFGR & ((0x3UL << (1U)) | (0x1UL << (0U)));




  if ((tmp1 == (((0x1UL << (0U)) | (0x1UL << (1U))))) || (tmp1 == (((0x1UL << (0U)) | (0x2UL << (1U))))))
  {
  ...
  tmp1 = hi2s->Instance->I2SCFGR & (0x3UL << (8U));

  if ((tmp1 == ((0x2UL << (8U)))) || (tmp1 == (0x00000000U)))
  {
    ...
    if ((hi2s->Instance->I2SCFGR & (0x3UL << (8U))) == ((0x2UL << (8U))))
    {
    ...
    while ((hi2s->RxXferCount > 0U) || (hi2s->TxXferCount > 0U))
    {
      if (hi2s->TxXferCount > 0U)
      {
        ...
        if (I2SEx_FullDuplexWaitFlagStateUntilTimeout(hi2s, (0x1UL << (1U)), SET, Timeout, I2S_USE_I2S) != HAL_OK)
        {
        ...
        if ((((((hi2s)->Instance->SR) & ((0x1UL << (3U)))) == ((0x1UL << (3U)))) == SET) && (tmp1 == (0x00000000U)))
        {
      ...
      if (hi2s->RxXferCount > 0U)
      {
        ...
        if (I2SEx_FullDuplexWaitFlagStateUntilTimeout(hi2s, (0x1UL << (0U)), SET, Timeout, I2S_USE_I2SEXT) != HAL_OK)
        {
        ...
        (*pRxData++) = ((hi2s->Instance) == (((SPI_TypeDef *) (0x40000000UL + 0x3800UL)))? (SPI_TypeDef *)((0x40000000UL + 0x3400UL)): (SPI_TypeDef *)((0x40000000UL + 0x4000UL)))->DR;
        hi2s->RxXferCount--;


        if (((((((hi2s)->Instance) == (((SPI_TypeDef *) (0x40000000UL + 0x3800UL)))? (SPI_TypeDef *)((0x40000000UL + 0x3400UL)): (SPI_TypeDef *)((0x40000000UL + 0x4000UL)))->SR) & ((0x1UL << (6U)))) == ((0x1UL << (6U)))) == SET)
        {
  ...
  else
  {
    ...
    ((hi2s->Instance) == (((SPI_TypeDef *) (0x40000000UL + 0x3800UL)))? (SPI_TypeDef *)((0x40000000UL + 0x3400UL)): (SPI_TypeDef *)((0x40000000UL + 0x4000UL)))->DR = (*pTxData++);
    hi2s->TxXferCount--;
    ...
    while ((hi2s->RxXferCount > 0U) || (hi2s->TxXferCount > 0U))
    {
      if (hi2s->TxXferCount > 0U)
      {
        ...
        if (I2SEx_FullDuplexWaitFlagStateUntilTimeout(hi2s, (0x1UL << (1U)), SET, Timeout, I2S_USE_I2SEXT) != HAL_OK)
        {
        ...
        if ((((((((hi2s)->Instance) == (((SPI_TypeDef *) (0x40000000UL + 0x3800UL)))? (SPI_TypeDef *)((0x40000000UL + 0x3400UL)): (SPI_TypeDef *)((0x40000000UL + 0x4000UL)))->SR) & ((0x1UL << (3U)))) == ((0x1UL << (3U)))) == SET) && (tmp1 == ((0x1UL << (8U)))))
        {
      ...
      if (hi2s->RxXferCount > 0U)
      {
        ...
        if (I2SEx_FullDuplexWaitFlagStateUntilTimeout(hi2s, (0x1UL << (0U)), SET, Timeout, I2S_USE_I2S) != HAL_OK)
        {
...
# 423 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_i2s_ex.c"
HAL_StatusTypeDef HAL_I2SEx_TransmitReceive_IT(I2S_HandleTypeDef *hi2s, uint16_t *pTxData, uint16_t *pRxData,
                                               uint16_t Size)
{
  uint32_t tmp1 = 0U;
  ...
  if ((pTxData == 
# 435 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_i2s_ex.c" 3 4
                 ((void *)0)
# 435 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_i2s_ex.c"
                     ) || (pRxData == 
# 435 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_i2s_ex.c" 3 4
                                      ((void *)0)
# 435 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_i2s_ex.c"
  ...
  if ((hi2s->Init.Mode == ((0x2UL << (8U)))) || (hi2s->Init.Mode == (0x00000000U)))
  {
    ...
    ((((hi2s)->Instance) == (((SPI_TypeDef *) (0x40000000UL + 0x3800UL)))? (SPI_TypeDef *)((0x40000000UL + 0x3400UL)): (SPI_TypeDef *)((0x40000000UL + 0x4000UL)))->CR2 |= (((0x1UL << (6U)) | (0x1UL << (5U)))));
  ...
  else
  {
    ...
    ((((hi2s)->Instance) == (((SPI_TypeDef *) (0x40000000UL + 0x3800UL)))? (SPI_TypeDef *)((0x40000000UL + 0x3400UL)): (SPI_TypeDef *)((0x40000000UL + 0x4000UL)))->CR2 |= (((0x1UL << (7U)) | (0x1UL << (5U)))));


    ((((hi2s)->Instance->CR2) |= ((((0x1UL << (6U)) | (0x1UL << (5U)))))));


    ((hi2s->Instance) == (((SPI_TypeDef *) (0x40000000UL + 0x3800UL)))? (SPI_TypeDef *)((0x40000000UL + 0x3400UL)): (SPI_TypeDef *)((0x40000000UL + 0x4000UL)))->DR = (*hi2s->pTxBuffPtr++);
    hi2s->TxXferCount--;
...
# 533 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_i2s_ex.c"
HAL_StatusTypeDef HAL_I2SEx_TransmitReceive_DMA(I2S_HandleTypeDef *hi2s, uint16_t *pTxData, uint16_t *pRxData,
                                                uint16_t Size)
{
  uint32_t *tmp = 
# 536 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_i2s_ex.c" 3 4
                 ((void *)0)
# 536 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_i2s_ex.c"
                     ;
  uint32_t tmp1 = 0U;
  HAL_StatusTypeDef errorcode = HAL_OK;
  ...
  if ((pTxData == 
# 546 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_i2s_ex.c" 3 4
                 ((void *)0)
# 546 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_i2s_ex.c"
                     ) || (pRxData == 
# 546 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_i2s_ex.c" 3 4
                                      ((void *)0)
# 546 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_i2s_ex.c"
  ...
  if ((tmp1 == ((0x2UL << (8U)))) || (tmp1 == (0x00000000U)))
  {
    ...
    HAL_DMA_Start_IT(hi2s->hdmarx, (uint32_t)&((hi2s->Instance) == (((SPI_TypeDef *) (0x40000000UL + 0x3800UL)))? (SPI_TypeDef *)((0x40000000UL + 0x3400UL)): (SPI_TypeDef *)((0x40000000UL + 0x4000UL)))->DR, *(uint32_t *)tmp, hi2s->RxXferSize);
  ...
  else
  {
    ...
    tmp = (uint32_t *)&pTxData;
    HAL_DMA_Start_IT(hi2s->hdmatx, *(uint32_t *)tmp, (uint32_t)&((hi2s->Instance) == (((SPI_TypeDef *) (0x40000000UL + 0x3800UL)))? (SPI_TypeDef *)((0x40000000UL + 0x3400UL)): (SPI_TypeDef *)((0x40000000UL + 0x4000UL)))->DR, hi2s->TxXferSize);
...
void HAL_I2SEx_FullDuplex_IRQHandler(I2S_HandleTypeDef *hi2s)
{
  ...
  volatile uint32_t i2sextsr = ((hi2s->Instance) == (((SPI_TypeDef *) (0x40000000UL + 0x3800UL)))? (SPI_TypeDef *)((0x40000000UL + 0x3400UL)): (SPI_TypeDef *)((0x40000000UL + 0x4000UL)))->SR;
  volatile uint32_t i2scr2 = hi2s->Instance->CR2;
  volatile uint32_t i2sextcr2 = ((hi2s->Instance) == (((SPI_TypeDef *) (0x40000000UL + 0x3800UL)))? (SPI_TypeDef *)((0x40000000UL + 0x3400UL)): (SPI_TypeDef *)((0x40000000UL + 0x4000UL)))->CR2;


  if ((hi2s->Init.Mode == ((0x2UL << (8U)))) || (hi2s->Init.Mode == (0x00000000U)))
  {

    if (((i2ssr & (0x1UL << (1U))) == (0x1UL << (1U))) && ((i2scr2 & (0x1UL << (7U))) != RESET))
    {
    ...
    if (((i2sextsr & (0x1UL << (0U))) == (0x1UL << (0U))) && ((i2sextcr2 & (0x1UL << (6U))) != RESET))
    {
    ...
    if (((i2sextsr & (0x1UL << (6U))) == (0x1UL << (6U))) && ((i2sextcr2 & (0x1UL << (5U))) != RESET))
    {
    ...
    if (((i2ssr & (0x1UL << (3U))) == (0x1UL << (3U))) && ((i2scr2 & (0x1UL << (5U))) != RESET))
    {
  ...
  else
  {
    ...
    if (((i2sextsr & (0x1UL << (1U))) == (0x1UL << (1U))) && ((i2sextcr2 & (0x1UL << (7U))) != RESET))
    {
    ...
    if (((i2ssr & (0x1UL << (0U))) == (0x1UL << (0U))) && ((i2scr2 & (0x1UL << (6U))) != RESET))
    {
    ...
    if (((i2ssr & (0x1UL << (6U))) == (0x1UL << (6U))) && ((i2scr2 & (0x1UL << (5U))) != RESET))
    {
    ...
    if (((i2sextsr & (0x1UL << (3U))) == (0x1UL << (3U))) && ((i2sextcr2 & (0x1UL << (5U))) != RESET))
    {
...
__attribute__((weak)) void HAL_I2SEx_TxRxHalfCpltCallback(I2S_HandleTypeDef *hi2s)
{
...
__attribute__((weak)) void HAL_I2SEx_TxRxCpltCallback(I2S_HandleTypeDef *hi2s)
{
...
# 858 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_i2s_ex.c"
static void I2SEx_TxRxDMAHalfCplt(DMA_HandleTypeDef *hdma)
{
...
static void I2SEx_TxRxDMACplt(DMA_HandleTypeDef *hdma)
{
  ...
  if (hdma->Init.Mode == 0x00000000U)
  {
    if (hi2s->hdmarx == hdma)
    {
      ...
      if (((hi2s->Instance->I2SCFGR & (0x3UL << (8U))) == ((0x2UL << (8U)))) ||
          ((hi2s->Instance->I2SCFGR & (0x3UL << (8U))) == (0x00000000U)))
      {
        ((((hi2s->Instance) == (((SPI_TypeDef *) (0x40000000UL + 0x3800UL)))? (SPI_TypeDef *)((0x40000000UL + 0x3400UL)): (SPI_TypeDef *)((0x40000000UL + 0x4000UL)))->CR2) &= ~((0x1UL << (0U))));
      }
      else
...
static void I2SEx_RxISR_I2SExt(I2S_HandleTypeDef *hi2s)
{
  ...
  (*hi2s->pRxBuffPtr++) = ((hi2s->Instance) == (((SPI_TypeDef *) (0x40000000UL + 0x3800UL)))? (SPI_TypeDef *)((0x40000000UL + 0x3400UL)): (SPI_TypeDef *)((0x40000000UL + 0x4000UL)))->DR;
  hi2s->RxXferCount--;
...
# 1094 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_i2s_ex.c"
static HAL_StatusTypeDef I2SEx_FullDuplexWaitFlagStateUntilTimeout(I2S_HandleTypeDef *hi2s, uint32_t Flag,
                                                                   uint32_t State, uint32_t Timeout, I2S_UseTypeDef i2sUsed)
{
  ...
  else
  {
    ...
    while (((((((((hi2s)->Instance) == (((SPI_TypeDef *) (0x40000000UL + 0x3800UL)))? (SPI_TypeDef *)((0x40000000UL + 0x3400UL)): (SPI_TypeDef *)((0x40000000UL + 0x4000UL)))->SR) & (Flag)) == (Flag))) ? SET : RESET) != State)
    {
      if (Timeout != 0xFFFFFFFFU)
      {
        if ((Timeout == 0U) || ((HAL_GetTick() - tickstart) > Timeout))
