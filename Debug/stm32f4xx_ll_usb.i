...
# 42 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usb.c" 2
...
# 308 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usb.c"
  ...
  *(volatile uint32_t *)((uint32_t)USBx_BASE + 0xE00UL) = 0U;
  ...
  ((USB_OTG_DeviceTypeDef *)(USBx_BASE + 0x800UL))->DCFG |= 0U;
...
HAL_StatusTypeDef USB_EPStartXfer(USB_OTG_GlobalTypeDef *USBx, USB_OTG_EPTypeDef *ep, uint8_t dma)
{
  ...
  if (ep->is_in == 1U)
  {
    ...
    else
    {
      ...
      ((USB_OTG_INEndpointTypeDef *)(USBx_BASE + 0x900UL + ((epnum) * 0x20UL)))->DIEPTSIZ &= ~((0x7FFFFUL << (0U)));
      ((USB_OTG_INEndpointTypeDef *)(USBx_BASE + 0x900UL + ((epnum) * 0x20UL)))->DIEPTSIZ &= ~((0x3FFUL << (19U)));
      ((USB_OTG_INEndpointTypeDef *)(USBx_BASE + 0x900UL + ((epnum) * 0x20UL)))->DIEPTSIZ |= ((0x3FFUL << (19U)) & (((ep->xfer_len + ep->maxpacket - 1U) / ep->maxpacket) << 19));
      ...
      if (ep->type == 1U)
      {
        ...
        ((USB_OTG_INEndpointTypeDef *)(USBx_BASE + 0x900UL + ((epnum) * 0x20UL)))->DIEPTSIZ |= ((0x3UL << (29U)) & (1U << 29));
      }
    }
  ...
  else
  {
    ...
    else
    {
      ...
      ((USB_OTG_OUTEndpointTypeDef *)(USBx_BASE + 0xB00UL + ((epnum) * 0x20UL)))->DOEPTSIZ |= (0x7FFFFUL << (0U)) & (ep->maxpacket * pktcnt);
    }
                                  ...
                                  uint8_t ch_ep_num, uint16_t len, uint8_t dma)
{
  ...
  if (dma == 0U)
  {
    ...
    {
      *(volatile uint32_t *)(USBx_BASE + 0x1000UL + (((uint32_t)ch_ep_num) * 0x1000UL)) = (((const struct T_UINT32_READ *)(const void *)(pSrc))->v);
      pSrc++;
    }
  }
...
void *USB_ReadPacket(USB_OTG_GlobalTypeDef *USBx, uint8_t *dest, uint16_t len)
{
  ...
  for (i = 0U; i < count32b; i++)
  {
    (void)((((struct T_UINT32_WRITE *)(void *)(pDest))->v) = (*(volatile uint32_t *)(USBx_BASE + 0x1000UL + ((0U) * 0x1000UL))));
    pDest++;
  }
...
# 1371 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usb.c"
  ...
  USBx->GINTMSK |= ((0x1UL << (24U)) | (0x1UL << (25U)) |
                    (0x1UL << (3U)) | (0x1UL << (29U)) |
                    (0x1UL << (21U)) | (0x1UL << (31U)));
                              ...
                              uint8_t ep_type, uint16_t mps)
{
  ...
  switch (ep_type)
  {
    ...
    case 2U:
      ...
      else
      {
        if ((USBx->CID & (0x1U << 8)) != 0U)
        {
          ((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + (((uint32_t)ch_num) * 0x20UL)))->HCINTMSK |= ((0x1UL << (6U)) | (0x1UL << (5U)));
        }
      }
      break;
  ...
  ((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + (((uint32_t)ch_num) * 0x20UL)))->HCCHAR = (((uint32_t)dev_address << 22) & (0x7FUL << (22U))) |
                                      ...
                                      ((uint32_t)mps & (0x7FFUL << (0U))) | HCcharEpDir | HCcharLowSpeed;
...
HAL_StatusTypeDef USB_HC_StartXfer(USB_OTG_GlobalTypeDef *USBx, USB_OTG_HCTypeDef *hc, uint8_t dma)
{
  ...
  if (((USBx->CID & (0x1U << 8)) != 0U) && (hc->speed == 0U))
  {
    ...
    {
      ((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((ch_num) * 0x20UL)))->HCINTMSK &= ~((0x1UL << (6U)) | (0x1UL << (5U)));
      hc->do_ping = 0U;
    }
    else
    {
  ...
  ((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((ch_num) * 0x20UL)))->HCTSIZ = (hc->xfer_len & (0x7FFFFUL << (0U))) |
...
HAL_StatusTypeDef USB_HC_Halt(USB_OTG_GlobalTypeDef *USBx, uint8_t hc_num)
{
  ...
  if ((HcEpType == 0U) || (HcEpType == 2U))
  {
    ...
    if ((USBx->HNPTXSTS & (0xFFU << 16)) == 0U)
    {
      ...
      ((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((hcnum) * 0x20UL)))->HCCHAR |= (0x1UL << (31U));
      ((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((hcnum) * 0x20UL)))->HCCHAR &= ~(0x1UL << (15U));
      do
      {
        if (++count > 1000U)
        {
