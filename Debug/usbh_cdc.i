# 1 "../Middlewares/ST/STM32_USB_Host_Library/Class/CDC/Src/usbh_cdc.c"
...
#define DEBUG 1
# 1 "../Middlewares/ST/STM32_USB_Host_Library/Class/CDC/Src/usbh_cdc.c"
# 49 "../Middlewares/ST/STM32_USB_Host_Library/Class/CDC/Src/usbh_cdc.c"
# 1 "../Middlewares/ST/STM32_USB_Host_Library/Class/CDC/Inc/usbh_cdc.h" 1
# 22 "../Middlewares/ST/STM32_USB_Host_Library/Class/CDC/Inc/usbh_cdc.h"
#define __USBH_CDC_H 
...
# 30 "../Middlewares/ST/STM32_USB_Host_Library/Class/CDC/Inc/usbh_cdc.h" 2
# 53 "../Middlewares/ST/STM32_USB_Host_Library/Class/CDC/Inc/usbh_cdc.h"
...
# 138 "../Middlewares/ST/STM32_USB_Host_Library/Class/CDC/Inc/usbh_cdc.h"
typedef enum
{
  CDC_IDLE = 0U,
  CDC_SEND_DATA,
...
# 200 "../Middlewares/ST/STM32_USB_Host_Library/Class/CDC/Inc/usbh_cdc.h"
...
# 241 "../Middlewares/ST/STM32_USB_Host_Library/Class/CDC/Inc/usbh_cdc.h"
...
# 279 "../Middlewares/ST/STM32_USB_Host_Library/Class/CDC/Inc/usbh_cdc.h"
...
# 302 "../Middlewares/ST/STM32_USB_Host_Library/Class/CDC/Inc/usbh_cdc.h"
...
CDC_HandleTypeDef;
# 386 "../Middlewares/ST/STM32_USB_Host_Library/Class/CDC/Inc/usbh_cdc.h"
extern USBH_ClassTypeDef CDC_Class;
#define USBH_CDC_CLASS &CDC_Class
# 397 "../Middlewares/ST/STM32_USB_Host_Library/Class/CDC/Inc/usbh_cdc.h"
...
# 50 "../Middlewares/ST/STM32_USB_Host_Library/Class/CDC/Src/usbh_cdc.c" 2
# 79 "../Middlewares/ST/STM32_USB_Host_Library/Class/CDC/Src/usbh_cdc.c"
#define USBH_CDC_BUFFER_SIZE 1024
# 105 "../Middlewares/ST/STM32_USB_Host_Library/Class/CDC/Src/usbh_cdc.c"
...
# 134 "../Middlewares/ST/STM32_USB_Host_Library/Class/CDC/Src/usbh_cdc.c" 3 4
 ((void *)0)
# 134 "../Middlewares/ST/STM32_USB_Host_Library/Class/CDC/Src/usbh_cdc.c"
     ,
};
# 151 "../Middlewares/ST/STM32_USB_Host_Library/Class/CDC/Src/usbh_cdc.c"
static USBH_StatusTypeDef USBH_CDC_InterfaceInit(USBH_HandleTypeDef *phost)
{
  ...
  interface = USBH_FindInterface(phost, 0x02U,
                                 0x02U, 0x01U);

  if ((interface == 0xFFU) || (interface >= 2U))
  {
    do {} while (0);
    return USBH_FAIL;
  }
  ...
  phost->pActiveClass->pData = (CDC_HandleTypeDef *)malloc(sizeof(CDC_HandleTypeDef));
  CDC_Handle = (CDC_HandleTypeDef *) phost->pActiveClass->pData;

  if (CDC_Handle == 
# 177 "../Middlewares/ST/STM32_USB_Host_Library/Class/CDC/Src/usbh_cdc.c" 3 4
                   ((void *)0)
# 177 "../Middlewares/ST/STM32_USB_Host_Library/Class/CDC/Src/usbh_cdc.c"
                       )
  {
    do {} while (0);
    return USBH_FAIL;
  ...
  memset(CDC_Handle, 0, sizeof(CDC_HandleTypeDef));
  ...
  USBH_OpenPipe(phost, CDC_Handle->CommItf.NotifPipe, CDC_Handle->CommItf.NotifEp,
                phost->device.address, phost->device.speed, 0x03U,
                CDC_Handle->CommItf.NotifEpSize);

  USBH_LL_SetToggle(phost, CDC_Handle->CommItf.NotifPipe, 0U);

  interface = USBH_FindInterface(phost, 0x0AU,
                                 0x00U, 0x00U);
  ...
  USBH_OpenPipe(phost, CDC_Handle->DataItf.OutPipe, CDC_Handle->DataItf.OutEp,
                phost->device.address, phost->device.speed, 0x02U,
...
# 267 "../Middlewares/ST/STM32_USB_Host_Library/Class/CDC/Src/usbh_cdc.c"
static USBH_StatusTypeDef USBH_CDC_InterfaceDeInit(USBH_HandleTypeDef *phost)
{
  ...
  if (CDC_Handle->CommItf.NotifPipe)
  {
    ...
    CDC_Handle->CommItf.NotifPipe = 0U;
  }
...
# 308 "../Middlewares/ST/STM32_USB_Host_Library/Class/CDC/Src/usbh_cdc.c"
static USBH_StatusTypeDef USBH_CDC_ClassRequest(USBH_HandleTypeDef *phost)
{
  USBH_StatusTypeDef status;
  CDC_HandleTypeDef *CDC_Handle = (CDC_HandleTypeDef *) phost->pActiveClass->pData;
...
# 338 "../Middlewares/ST/STM32_USB_Host_Library/Class/CDC/Src/usbh_cdc.c"
static USBH_StatusTypeDef USBH_CDC_Process(USBH_HandleTypeDef *phost)
{
...
# 437 "../Middlewares/ST/STM32_USB_Host_Library/Class/CDC/Src/usbh_cdc.c"
USBH_StatusTypeDef USBH_CDC_Stop(USBH_HandleTypeDef *phost)
{
  CDC_HandleTypeDef *CDC_Handle = (CDC_HandleTypeDef *) phost->pActiveClass->pData;
...
static USBH_StatusTypeDef GetLineCoding(USBH_HandleTypeDef *phost, CDC_LineCodingTypeDef *linecoding)
{
  ...
  phost->Control.setup.b.bRequest = 0x21U;
  phost->Control.setup.b.wValue.w = 0U;
  phost->Control.setup.b.wIndex.w = 0U;
  phost->Control.setup.b.wLength.w = 0x07U;

  return USBH_CtlReq(phost, linecoding->Array, 0x07U);
}
# 480 "../Middlewares/ST/STM32_USB_Host_Library/Class/CDC/Src/usbh_cdc.c"
static USBH_StatusTypeDef SetLineCoding(USBH_HandleTypeDef *phost,
                                        CDC_LineCodingTypeDef *linecoding)
{
  ...
  phost->Control.setup.b.bRequest = 0x20U;
  phost->Control.setup.b.wValue.w = 0U;
...
# 519 "../Middlewares/ST/STM32_USB_Host_Library/Class/CDC/Src/usbh_cdc.c"
  }
...
USBH_StatusTypeDef USBH_CDC_Transmit(USBH_HandleTypeDef *phost, uint8_t *pbuff, uint32_t length)
{
  ...
  if ((CDC_Handle->state == CDC_IDLE_STATE) || (CDC_Handle->state == CDC_TRANSFER_DATA))
  {
    ...
    Status = USBH_OK;
# 593 "../Middlewares/ST/STM32_USB_Host_Library/Class/CDC/Src/usbh_cdc.c"
  }
  return Status;
}
...
USBH_StatusTypeDef USBH_CDC_Receive(USBH_HandleTypeDef *phost, uint8_t *pbuff, uint32_t length)
{
  ...
  if ((CDC_Handle->state == CDC_IDLE_STATE) || (CDC_Handle->state == CDC_TRANSFER_DATA))
  {
    ...
    Status = USBH_OK;
# 624 "../Middlewares/ST/STM32_USB_Host_Library/Class/CDC/Src/usbh_cdc.c"
  }
  return Status;
}
...
# 696 "../Middlewares/ST/STM32_USB_Host_Library/Class/CDC/Src/usbh_cdc.c"
      }
      else
      {
        ...
        {
          CDC_Handle->data_tx_state = CDC_SEND_DATA;
# 711 "../Middlewares/ST/STM32_USB_Host_Library/Class/CDC/Src/usbh_cdc.c"
        }
      }
      break;
...
# 774 "../Middlewares/ST/STM32_USB_Host_Library/Class/CDC/Src/usbh_cdc.c"
      }
      break;
...
__attribute__((weak)) void USBH_CDC_TransmitCallback(USBH_HandleTypeDef *phost)
{
...
__attribute__((weak)) void USBH_CDC_ReceiveCallback(USBH_HandleTypeDef *phost)
{
...
__attribute__((weak)) void USBH_CDC_LineCodingChanged(USBH_HandleTypeDef *phost)
{
