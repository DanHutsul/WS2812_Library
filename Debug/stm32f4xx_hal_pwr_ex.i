...
# 26 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pwr_ex.c" 2
# 43 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pwr_ex.c"
...
uint32_t HAL_PWREx_GetVoltageRange(void)
{
  return (((PWR_TypeDef *) (0x40000000UL + 0x7000UL))->CR & (0x3UL << (14U)));
}
# 290 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pwr_ex.c"
HAL_StatusTypeDef HAL_PWREx_ControlVoltageScaling(uint32_t VoltageScaling)
{
  uint32_t tickstart = 0U;
  ...
  if((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->CFGR & (0x3UL << (2U))) != 0x00000008U)
  {
    ...
    do { volatile uint32_t tmpreg = 0x00U; (((((PWR_TypeDef *) (0x40000000UL + 0x7000UL))->CR)) = ((((((((PWR_TypeDef *) (0x40000000UL + 0x7000UL))->CR))) & (~((0x3UL << (14U))))) | ((VoltageScaling))))); tmpreg = ((((PWR_TypeDef *) (0x40000000UL + 0x7000UL))->CR) & ((0x3UL << (14U)))); (void)tmpreg; } while(0U);
...
void HAL_PWREx_EnableMainRegulatorLowVoltage(void)
{
  *(volatile uint32_t *) (uint32_t)(0x42000000UL + ((((0x40000000UL + 0x7000UL) - 0x40000000UL) + 0x00U) * 32U) + ((11U) * 4U)) = (uint32_t)ENABLE;
}
...
void HAL_PWREx_DisableMainRegulatorLowVoltage(void)
{
  *(volatile uint32_t *) (uint32_t)(0x42000000UL + ((((0x40000000UL + 0x7000UL) - 0x40000000UL) + 0x00U) * 32U) + ((11U) * 4U)) = (uint32_t)DISABLE;
}
...
void HAL_PWREx_EnableLowRegulatorLowVoltage(void)
{
  *(volatile uint32_t *) (uint32_t)(0x42000000UL + ((((0x40000000UL + 0x7000UL) - 0x40000000UL) + 0x00U) * 32U) + ((10U) * 4U)) = (uint32_t)ENABLE;
}
...
void HAL_PWREx_DisableLowRegulatorLowVoltage(void)
{
  *(volatile uint32_t *) (uint32_t)(0x42000000UL + ((((0x40000000UL + 0x7000UL) - 0x40000000UL) + 0x00U) * 32U) + ((10U) * 4U)) = (uint32_t)DISABLE;
}
