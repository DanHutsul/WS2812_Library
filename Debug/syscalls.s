...
@ options passed:  -fpreprocessed syscalls.i -mcpu=cortex-m4
@ -mfpu=fpv4-sp-d16 -mfloat-abi=hard -mthumb
@ -auxbase-strip Core/Src/syscalls.o -g3 -O0 -Wall -std=gnu11
...
.LFB20:
	...
	add	r7, sp, #0	@,,
	.cfi_def_cfa_register 7
@ ../Core/Src/syscalls.c:54: 	return 1;
	.loc 1 54 0
	movs	r3, #1	@ _1,
@ ../Core/Src/syscalls.c:55: }
	.loc 1 55 0
	mov	r0, r3	@, <retval>
	mov	sp, r7	@,
	.cfi_def_cfa_register 13
...
.LFB21:
	...
	str	r0, [r7, #4]	@ pid, pid
	str	r1, [r7]	@ sig, sig
@ ../Core/Src/syscalls.c:59: 	errno = EINVAL;
	.loc 1 59 0
	bl	__errno	@
	mov	r2, r0	@ _1,
@ ../Core/Src/syscalls.c:59: 	errno = EINVAL;
	...
	movs	r3, #22	@ tmp113,
	str	r3, [r2]	@ tmp113, *_1
@ ../Core/Src/syscalls.c:60: 	return -1;
	.loc 1 60 0
	mov	r3, #-1	@ _5,
@ ../Core/Src/syscalls.c:61: }
	.loc 1 61 0
	mov	r0, r3	@, <retval>
	adds	r7, r7, #8	@,,
	.cfi_def_cfa_offset 8
...
.LFB22:
	...
	add	r7, sp, #0	@,,
	.cfi_def_cfa_register 7
	str	r0, [r7, #4]	@ status, status
@ ../Core/Src/syscalls.c:65: 	_kill(status, -1);
	.loc 1 65 0
	mov	r1, #-1	@,
	ldr	r0, [r7, #4]	@, status
	bl	_kill	@
.L7:
@ ../Core/Src/syscalls.c:66: 	while (1) {}		/* Make sure we hang here */
...
.LFB23:
	...
	add	r7, sp, #0	@,,
	.cfi_def_cfa_register 7
	str	r0, [r7, #12]	@ file, file
	str	r1, [r7, #8]	@ ptr, ptr
	str	r2, [r7, #4]	@ len, len
@ ../Core/Src/syscalls.c:73: 	for (DataIdx = 0; DataIdx < len; DataIdx++)
	.loc 1 73 0
	movs	r3, #0	@ tmp115,
	str	r3, [r7, #20]	@ tmp115, DataIdx
	b	.L9	@
.L10:
@ ../Core/Src/syscalls.c:75: 		*ptr++ = __io_getchar();
	.loc 1 75 0 discriminator 3
	bl	__io_getchar	@
	mov	r1, r0	@ _1,
	ldr	r3, [r7, #8]	@ ptr.0_2, ptr
	adds	r2, r3, #1	@ tmp116, ptr.0_2,
	str	r2, [r7, #8]	@ tmp116, ptr
	uxtb	r2, r1	@ _3, _1
	strb	r2, [r3]	@ tmp117, *ptr.0_2
@ ../Core/Src/syscalls.c:73: 	for (DataIdx = 0; DataIdx < len; DataIdx++)
	.loc 1 73 0 discriminator 3
	ldr	r3, [r7, #20]	@ tmp119, DataIdx
	adds	r3, r3, #1	@ tmp118, tmp119,
	str	r3, [r7, #20]	@ tmp118, DataIdx
.L9:
@ ../Core/Src/syscalls.c:73: 	for (DataIdx = 0; DataIdx < len; DataIdx++)
	.loc 1 73 0 is_stmt 0 discriminator 1
	ldr	r2, [r7, #20]	@ tmp120, DataIdx
	ldr	r3, [r7, #4]	@ tmp121, len
	cmp	r2, r3	@ tmp120, tmp121
	blt	.L10	@,
@ ../Core/Src/syscalls.c:78: return len;
	.loc 1 78 0 is_stmt 1
	ldr	r3, [r7, #4]	@ _11, len
@ ../Core/Src/syscalls.c:79: }
	.loc 1 79 0
	mov	r0, r3	@, <retval>
	adds	r7, r7, #24	@,,
	.cfi_def_cfa_offset 8
...
.LFB24:
	...
	str	r1, [r7, #8]	@ ptr, ptr
	str	r2, [r7, #4]	@ len, len
@ ../Core/Src/syscalls.c:85: 	for (DataIdx = 0; DataIdx < len; DataIdx++)
	.loc 1 85 0
	movs	r3, #0	@ tmp115,
	str	r3, [r7, #20]	@ tmp115, DataIdx
	b	.L13	@
.L14:
@ ../Core/Src/syscalls.c:87: 		__io_putchar(*ptr++);
	.loc 1 87 0 discriminator 3
	ldr	r3, [r7, #8]	@ ptr.1_1, ptr
	adds	r2, r3, #1	@ tmp116, ptr.1_1,
	str	r2, [r7, #8]	@ tmp116, ptr
	ldrb	r3, [r3]	@ zero_extendqisi2	@ _2, *ptr.1_1
	mov	r0, r3	@, _3
	bl	__io_putchar	@
@ ../Core/Src/syscalls.c:85: 	for (DataIdx = 0; DataIdx < len; DataIdx++)
	.loc 1 85 0 discriminator 3
	ldr	r3, [r7, #20]	@ tmp118, DataIdx
	adds	r3, r3, #1	@ tmp117, tmp118,
	str	r3, [r7, #20]	@ tmp117, DataIdx
.L13:
@ ../Core/Src/syscalls.c:85: 	for (DataIdx = 0; DataIdx < len; DataIdx++)
	.loc 1 85 0 is_stmt 0 discriminator 1
	ldr	r2, [r7, #20]	@ tmp119, DataIdx
	ldr	r3, [r7, #4]	@ tmp120, len
	cmp	r2, r3	@ tmp119, tmp120
	blt	.L14	@,
@ ../Core/Src/syscalls.c:89: 	return len;
	.loc 1 89 0 is_stmt 1
	ldr	r3, [r7, #4]	@ _11, len
@ ../Core/Src/syscalls.c:90: }
	.loc 1 90 0
	mov	r0, r3	@, <retval>
	adds	r7, r7, #24	@,,
	.cfi_def_cfa_offset 8
...
.LFB25:
	...
	add	r7, sp, #0	@,,
	.cfi_def_cfa_register 7
	str	r0, [r7, #4]	@ file, file
@ ../Core/Src/syscalls.c:94: 	return -1;
	.loc 1 94 0
	mov	r3, #-1	@ _1,
@ ../Core/Src/syscalls.c:95: }
	.loc 1 95 0
	mov	r0, r3	@, <retval>
	adds	r7, r7, #12	@,,
	.cfi_def_cfa_offset 4
...
.LFB26:
	...
	str	r0, [r7, #4]	@ file, file
	str	r1, [r7]	@ st, st
@ ../Core/Src/syscalls.c:100: 	st->st_mode = S_IFCHR;
	.loc 1 100 0
	ldr	r3, [r7]	@ tmp112, st
	mov	r2, #8192	@ tmp113,
	str	r2, [r3, #4]	@ tmp113, st_2(D)->st_mode
@ ../Core/Src/syscalls.c:101: 	return 0;
	.loc 1 101 0
	movs	r3, #0	@ _4,
@ ../Core/Src/syscalls.c:102: }
	.loc 1 102 0
	mov	r0, r3	@, <retval>
	adds	r7, r7, #12	@,,
	.cfi_def_cfa_offset 4
...
.LFB27:
	...
	.cfi_def_cfa_register 7
	str	r0, [r7, #4]	@ file, file
@ ../Core/Src/syscalls.c:106: 	return 1;
	.loc 1 106 0
	movs	r3, #1	@ _1,
@ ../Core/Src/syscalls.c:107: }
	.loc 1 107 0
	mov	r0, r3	@, <retval>
	adds	r7, r7, #12	@,,
	.cfi_def_cfa_offset 4
...
.LFB28:
	...
	str	r1, [r7, #8]	@ ptr, ptr
	str	r2, [r7, #4]	@ dir, dir
@ ../Core/Src/syscalls.c:111: 	return 0;
	.loc 1 111 0
	movs	r3, #0	@ _1,
@ ../Core/Src/syscalls.c:112: }
	.loc 1 112 0
	mov	r0, r3	@, <retval>
	adds	r7, r7, #20	@,,
	.cfi_def_cfa_offset 4
...
.LFB29:
	...
	add	r7, sp, #0	@,,
	.cfi_def_cfa_register 7
	str	r0, [r7, #4]	@ path, path
@ ../Core/Src/syscalls.c:117: 	return -1;
	.loc 1 117 0
	mov	r3, #-1	@ _1,
@ ../Core/Src/syscalls.c:118: }
	.loc 1 118 0
	mov	r0, r3	@, <retval>
	adds	r7, r7, #8	@,,
	.cfi_def_cfa_offset 16
...
.LFB30:
	...
	.cfi_def_cfa_register 7
	str	r0, [r7, #4]	@ status, status
@ ../Core/Src/syscalls.c:122: 	errno = ECHILD;
	.loc 1 122 0
	bl	__errno	@
	mov	r2, r0	@ _1,
@ ../Core/Src/syscalls.c:122: 	errno = ECHILD;
	...
	movs	r3, #10	@ tmp113,
	str	r3, [r2]	@ tmp113, *_1
@ ../Core/Src/syscalls.c:123: 	return -1;
	.loc 1 123 0
	mov	r3, #-1	@ _5,
@ ../Core/Src/syscalls.c:124: }
	.loc 1 124 0
	mov	r0, r3	@, <retval>
	adds	r7, r7, #8	@,,
	.cfi_def_cfa_offset 8
...
.LFB31:
	...
	add	r7, sp, #0	@,,
	.cfi_def_cfa_register 7
	str	r0, [r7, #4]	@ name, name
@ ../Core/Src/syscalls.c:128: 	errno = ENOENT;
	.loc 1 128 0
	bl	__errno	@
	mov	r2, r0	@ _1,
@ ../Core/Src/syscalls.c:128: 	errno = ENOENT;
	...
	movs	r3, #2	@ tmp113,
	str	r3, [r2]	@ tmp113, *_1
@ ../Core/Src/syscalls.c:129: 	return -1;
	.loc 1 129 0
	mov	r3, #-1	@ _5,
@ ../Core/Src/syscalls.c:130: }
	.loc 1 130 0
	mov	r0, r3	@, <retval>
	adds	r7, r7, #8	@,,
	.cfi_def_cfa_offset 8
...
.LFB32:
	...
	.cfi_def_cfa_register 7
	str	r0, [r7, #4]	@ buf, buf
@ ../Core/Src/syscalls.c:134: 	return -1;
	.loc 1 134 0
	mov	r3, #-1	@ _1,
@ ../Core/Src/syscalls.c:135: }
	.loc 1 135 0
	mov	r0, r3	@, <retval>
	adds	r7, r7, #12	@,,
	.cfi_def_cfa_offset 4
...
.LFB33:
	...
	str	r0, [r7, #4]	@ file, file
	str	r1, [r7]	@ st, st
@ ../Core/Src/syscalls.c:139: 	st->st_mode = S_IFCHR;
	.loc 1 139 0
	ldr	r3, [r7]	@ tmp112, st
	mov	r2, #8192	@ tmp113,
	str	r2, [r3, #4]	@ tmp113, st_2(D)->st_mode
@ ../Core/Src/syscalls.c:140: 	return 0;
	.loc 1 140 0
	movs	r3, #0	@ _4,
@ ../Core/Src/syscalls.c:141: }
	.loc 1 141 0
	mov	r0, r3	@, <retval>
	adds	r7, r7, #12	@,,
	.cfi_def_cfa_offset 4
...
.LFB34:
	...
	str	r0, [r7, #4]	@ old, old
	str	r1, [r7]	@ new, new
@ ../Core/Src/syscalls.c:145: 	errno = EMLINK;
	.loc 1 145 0
	bl	__errno	@
	mov	r2, r0	@ _1,
@ ../Core/Src/syscalls.c:145: 	errno = EMLINK;
	...
	movs	r3, #31	@ tmp113,
	str	r3, [r2]	@ tmp113, *_1
@ ../Core/Src/syscalls.c:146: 	return -1;
	.loc 1 146 0
	mov	r3, #-1	@ _5,
@ ../Core/Src/syscalls.c:147: }
	.loc 1 147 0
	mov	r0, r3	@, <retval>
	adds	r7, r7, #8	@,,
	.cfi_def_cfa_offset 8
...
.LFB35:
	...
	add	r7, sp, #0	@,,
	.cfi_def_cfa_register 7
@ ../Core/Src/syscalls.c:151: 	errno = EAGAIN;
	.loc 1 151 0
	bl	__errno	@
	mov	r2, r0	@ _1,
@ ../Core/Src/syscalls.c:151: 	errno = EAGAIN;
	...
	movs	r3, #11	@ tmp113,
	str	r3, [r2]	@ tmp113, *_1
@ ../Core/Src/syscalls.c:152: 	return -1;
	.loc 1 152 0
	mov	r3, #-1	@ _5,
@ ../Core/Src/syscalls.c:153: }
	.loc 1 153 0
	mov	r0, r3	@, <retval>
	pop	{r7, pc}	@
	.cfi_endproc
...
.LFB36:
	...
	add	r7, sp, #0	@,,
	.cfi_def_cfa_register 7
	str	r0, [r7, #12]	@ name, name
	str	r1, [r7, #8]	@ argv, argv
	str	r2, [r7, #4]	@ env, env
@ ../Core/Src/syscalls.c:157: 	errno = ENOMEM;
	.loc 1 157 0
	bl	__errno	@
	mov	r2, r0	@ _1,
@ ../Core/Src/syscalls.c:157: 	errno = ENOMEM;
	...
	movs	r3, #12	@ tmp113,
	str	r3, [r2]	@ tmp113, *_1
@ ../Core/Src/syscalls.c:158: 	return -1;
	.loc 1 158 0
	mov	r3, #-1	@ _5,
@ ../Core/Src/syscalls.c:159: }
	.loc 1 159 0
	mov	r0, r3	@, <retval>
	adds	r7, r7, #16	@,,
	.cfi_def_cfa_offset 8
...
.Letext0:
	...
	.file 7 "d:\\da\\soft\\stm32cubeide_1.4.0\\stm32cubeide\\plugins\\com.st.stm32cube.ide.mcu.externaltools.gnu-tools-for-stm32.7-2018-q2-update.win32_1.4.0.202007081208\\tools\\arm-none-eabi\\include\\sys\\_timeval.h"
	.file 8 "d:\\da\\soft\\stm32cubeide_1.4.0\\stm32cubeide\\plugins\\com.st.stm32cube.ide.mcu.externaltools.gnu-tools-for-stm32.7-2018-q2-update.win32_1.4.0.202007081208\\tools\\arm-none-eabi\\include\\sys\\types.h"
	.file 9 "d:\\da\\soft\\stm32cubeide_1.4.0\\stm32cubeide\\plugins\\com.st.stm32cube.ide.mcu.externaltools.gnu-tools-for-stm32.7-2018-q2-update.win32_1.4.0.202007081208\\tools\\arm-none-eabi\\include\\time.h"
	.file 10 "d:\\da\\soft\\stm32cubeide_1.4.0\\stm32cubeide\\plugins\\com.st.stm32cube.ide.mcu.externaltools.gnu-tools-for-stm32.7-2018-q2-update.win32_1.4.0.202007081208\\tools\\arm-none-eabi\\include\\sys\\stat.h"
	.file 11 "d:\\da\\soft\\stm32cubeide_1.4.0\\stm32cubeide\\plugins\\com.st.stm32cube.ide.mcu.externaltools.gnu-tools-for-stm32.7-2018-q2-update.win32_1.4.0.202007081208\\tools\\arm-none-eabi\\include\\stdlib.h"
	.file 12 "d:\\da\\soft\\stm32cubeide_1.4.0\\stm32cubeide\\plugins\\com.st.stm32cube.ide.mcu.externaltools.gnu-tools-for-stm32.7-2018-q2-update.win32_1.4.0.202007081208\\tools\\arm-none-eabi\\include\\sys\\errno.h"
	.file 13 "d:\\da\\soft\\stm32cubeide_1.4.0\\stm32cubeide\\plugins\\com.st.stm32cube.ide.mcu.externaltools.gnu-tools-for-stm32.7-2018-q2-update.win32_1.4.0.202007081208\\tools\\arm-none-eabi\\include\\sys\\times.h"
...
.Ldebug_macro0:
	...
	.uleb128 0x2
	.4byte	.LASF441
	.file 14 "d:\\da\\soft\\stm32cubeide_1.4.0\\stm32cubeide\\plugins\\com.st.stm32cube.ide.mcu.externaltools.gnu-tools-for-stm32.7-2018-q2-update.win32_1.4.0.202007081208\\tools\\arm-none-eabi\\include\\_ansi.h"
	.byte	0x3
	.uleb128 0x8
	.uleb128 0xe
	.byte	0x5
	.uleb128 0x8
	.4byte	.LASF442
	.file 15 "d:\\da\\soft\\stm32cubeide_1.4.0\\stm32cubeide\\plugins\\com.st.stm32cube.ide.mcu.externaltools.gnu-tools-for-stm32.7-2018-q2-update.win32_1.4.0.202007081208\\tools\\arm-none-eabi\\include\\newlib-nano\\newlib.h"
	.byte	0x3
	.uleb128 0xa
	.uleb128 0xf
	.byte	0x5
	.uleb128 0x8
	.4byte	.LASF443
	.file 16 "d:\\da\\soft\\stm32cubeide_1.4.0\\stm32cubeide\\plugins\\com.st.stm32cube.ide.mcu.externaltools.gnu-tools-for-stm32.7-2018-q2-update.win32_1.4.0.202007081208\\tools\\arm-none-eabi\\include\\_newlib_version.h"
	.byte	0x3
	.uleb128 0xe
	.uleb128 0x10
	.byte	0x7
	...
	.4byte	.Ldebug_macro2
	.byte	0x4
	.file 17 "d:\\da\\soft\\stm32cubeide_1.4.0\\stm32cubeide\\plugins\\com.st.stm32cube.ide.mcu.externaltools.gnu-tools-for-stm32.7-2018-q2-update.win32_1.4.0.202007081208\\tools\\arm-none-eabi\\include\\sys\\config.h"
	.byte	0x3
	.uleb128 0xb
	.uleb128 0x11
	.byte	0x5
	.uleb128 0x2
	.4byte	.LASF459
	.file 18 "d:\\da\\soft\\stm32cubeide_1.4.0\\stm32cubeide\\plugins\\com.st.stm32cube.ide.mcu.externaltools.gnu-tools-for-stm32.7-2018-q2-update.win32_1.4.0.202007081208\\tools\\arm-none-eabi\\include\\machine\\ieeefp.h"
	.byte	0x3
	.uleb128 0x4
	.uleb128 0x12
	.byte	0x7
	.4byte	.Ldebug_macro3
	.byte	0x4
	.file 19 "d:\\da\\soft\\stm32cubeide_1.4.0\\stm32cubeide\\plugins\\com.st.stm32cube.ide.mcu.externaltools.gnu-tools-for-stm32.7-2018-q2-update.win32_1.4.0.202007081208\\tools\\arm-none-eabi\\include\\sys\\features.h"
	.byte	0x3
	.uleb128 0x5
	.uleb128 0x13
	.byte	0x7
	...
	.uleb128 0xe
	.byte	0x4
	.file 20 "d:\\da\\soft\\stm32cubeide_1.4.0\\stm32cubeide\\plugins\\com.st.stm32cube.ide.mcu.externaltools.gnu-tools-for-stm32.7-2018-q2-update.win32_1.4.0.202007081208\\tools\\arm-none-eabi\\include\\sys\\cdefs.h"
	.byte	0x3
	.uleb128 0xb
	.uleb128 0x14
	.byte	0x5
	...
	.uleb128 0x14
	.4byte	.LASF689
	.file 21 "d:\\da\\soft\\stm32cubeide_1.4.0\\stm32cubeide\\plugins\\com.st.stm32cube.ide.mcu.externaltools.gnu-tools-for-stm32.7-2018-q2-update.win32_1.4.0.202007081208\\tools\\arm-none-eabi\\include\\machine\\_types.h"
	.byte	0x3
	.uleb128 0x18
	.uleb128 0x15
	.byte	0x5
	...
	.byte	0x4
	.file 22 "d:\\da\\soft\\stm32cubeide_1.4.0\\stm32cubeide\\plugins\\com.st.stm32cube.ide.mcu.externaltools.gnu-tools-for-stm32.7-2018-q2-update.win32_1.4.0.202007081208\\tools\\arm-none-eabi\\include\\machine\\time.h"
	.byte	0x3
	.uleb128 0x13
	.uleb128 0x16
	.byte	0x7
	...
	.uleb128 0x5
	.byte	0x4
	.file 23 "d:\\da\\soft\\stm32cubeide_1.4.0\\stm32cubeide\\plugins\\com.st.stm32cube.ide.mcu.externaltools.gnu-tools-for-stm32.7-2018-q2-update.win32_1.4.0.202007081208\\tools\\arm-none-eabi\\include\\sys\\_stdint.h"
	.byte	0x3
	.uleb128 0x40
	.uleb128 0x17
	.byte	0x7
	...
	.byte	0x4
	.file 24 "d:\\da\\soft\\stm32cubeide_1.4.0\\stm32cubeide\\plugins\\com.st.stm32cube.ide.mcu.externaltools.gnu-tools-for-stm32.7-2018-q2-update.win32_1.4.0.202007081208\\tools\\arm-none-eabi\\include\\machine\\endian.h"
	.byte	0x3
	.uleb128 0x43
	.uleb128 0x18
	.byte	0x5
	.uleb128 0x2
	.4byte	.LASF799
	.file 25 "d:\\da\\soft\\stm32cubeide_1.4.0\\stm32cubeide\\plugins\\com.st.stm32cube.ide.mcu.externaltools.gnu-tools-for-stm32.7-2018-q2-update.win32_1.4.0.202007081208\\tools\\arm-none-eabi\\include\\machine\\_endian.h"
	.byte	0x3
	.uleb128 0x6
	.uleb128 0x19
	.byte	0x7
	...
	.byte	0x4
	.file 26 "d:\\da\\soft\\stm32cubeide_1.4.0\\stm32cubeide\\plugins\\com.st.stm32cube.ide.mcu.externaltools.gnu-tools-for-stm32.7-2018-q2-update.win32_1.4.0.202007081208\\tools\\arm-none-eabi\\include\\sys\\select.h"
	.byte	0x3
	.uleb128 0x44
	.uleb128 0x1a
	.byte	0x5
	.uleb128 0x2
	.4byte	.LASF817
	.file 27 "d:\\da\\soft\\stm32cubeide_1.4.0\\stm32cubeide\\plugins\\com.st.stm32cube.ide.mcu.externaltools.gnu-tools-for-stm32.7-2018-q2-update.win32_1.4.0.202007081208\\tools\\arm-none-eabi\\include\\sys\\_sigset.h"
	.byte	0x3
	.uleb128 0xe
	.uleb128 0x1b
	.byte	0x5
	...
	.byte	0x4
	.file 28 "d:\\da\\soft\\stm32cubeide_1.4.0\\stm32cubeide\\plugins\\com.st.stm32cube.ide.mcu.externaltools.gnu-tools-for-stm32.7-2018-q2-update.win32_1.4.0.202007081208\\tools\\arm-none-eabi\\include\\sys\\timespec.h"
	.byte	0x3
	.uleb128 0x10
	.uleb128 0x1c
	.byte	0x5
	.uleb128 0x23
	.4byte	.LASF829
	.file 29 "d:\\da\\soft\\stm32cubeide_1.4.0\\stm32cubeide\\plugins\\com.st.stm32cube.ide.mcu.externaltools.gnu-tools-for-stm32.7-2018-q2-update.win32_1.4.0.202007081208\\tools\\arm-none-eabi\\include\\sys\\_timespec.h"
	.byte	0x3
	.uleb128 0x26
	.uleb128 0x1d
	.byte	0x5
	...
	.file 30 "d:\\da\\soft\\stm32cubeide_1.4.0\\stm32cubeide\\plugins\\com.st.stm32cube.ide.mcu.externaltools.gnu-tools-for-stm32.7-2018-q2-update.win32_1.4.0.202007081208\\tools\\arm-none-eabi\\include\\sys\\_pthreadtypes.h"
	.byte	0x3
	.uleb128 0xef
	.uleb128 0x1e
	.byte	0x5
	.uleb128 0x13
	.4byte	.LASF875
	.file 31 "d:\\da\\soft\\stm32cubeide_1.4.0\\stm32cubeide\\plugins\\com.st.stm32cube.ide.mcu.externaltools.gnu-tools-for-stm32.7-2018-q2-update.win32_1.4.0.202007081208\\tools\\arm-none-eabi\\include\\sys\\sched.h"
	.byte	0x3
	.uleb128 0x17
	.uleb128 0x1f
	.byte	0x7
	...
	.byte	0x4
	.file 32 "d:\\da\\soft\\stm32cubeide_1.4.0\\stm32cubeide\\plugins\\com.st.stm32cube.ide.mcu.externaltools.gnu-tools-for-stm32.7-2018-q2-update.win32_1.4.0.202007081208\\tools\\arm-none-eabi\\include\\machine\\types.h"
	.byte	0x3
	.uleb128 0xf0
	.uleb128 0x20
	.byte	0x4
	...
	.4byte	.LASF889
	.byte	0x4
	.file 33 "d:\\da\\soft\\stm32cubeide_1.4.0\\stm32cubeide\\plugins\\com.st.stm32cube.ide.mcu.externaltools.gnu-tools-for-stm32.7-2018-q2-update.win32_1.4.0.202007081208\\tools\\arm-none-eabi\\include\\xlocale.h"
	.byte	0x3
	.uleb128 0x20
	.uleb128 0x21
	.byte	0x5
	...
	.4byte	.Ldebug_macro16
	.byte	0x4
	.file 34 "d:\\da\\soft\\stm32cubeide_1.4.0\\stm32cubeide\\plugins\\com.st.stm32cube.ide.mcu.externaltools.gnu-tools-for-stm32.7-2018-q2-update.win32_1.4.0.202007081208\\tools\\arm-none-eabi\\include\\machine\\stdlib.h"
	.byte	0x3
	.uleb128 0x14
	.uleb128 0x22
	.byte	0x5
	...
	.4byte	.LASF946
	.byte	0x4
	.file 35 "d:\\da\\soft\\stm32cubeide_1.4.0\\stm32cubeide\\plugins\\com.st.stm32cube.ide.mcu.externaltools.gnu-tools-for-stm32.7-2018-q2-update.win32_1.4.0.202007081208\\tools\\arm-none-eabi\\include\\alloca.h"
	.byte	0x3
	.uleb128 0x16
	.uleb128 0x23
	.byte	0x7
	...
	.byte	0x4
	.file 36 "d:\\da\\soft\\stm32cubeide_1.4.0\\stm32cubeide\\plugins\\com.st.stm32cube.ide.mcu.externaltools.gnu-tools-for-stm32.7-2018-q2-update.win32_1.4.0.202007081208\\tools\\arm-none-eabi\\include\\errno.h"
	.byte	0x3
	.uleb128 0x1b
	.uleb128 0x24
	.byte	0x7
	...
	.byte	0x4
	.byte	0x4
	.file 37 "d:\\da\\soft\\stm32cubeide_1.4.0\\stm32cubeide\\plugins\\com.st.stm32cube.ide.mcu.externaltools.gnu-tools-for-stm32.7-2018-q2-update.win32_1.4.0.202007081208\\tools\\arm-none-eabi\\include\\stdio.h"
	.byte	0x3
	.uleb128 0x1c
	.uleb128 0x25
	.byte	0x7
	...
	.uleb128 0x27
	.4byte	.LASF1049
	.file 38 "d:\\da\\soft\\stm32cubeide_1.4.0\\stm32cubeide\\plugins\\com.st.stm32cube.ide.mcu.externaltools.gnu-tools-for-stm32.7-2018-q2-update.win32_1.4.0.202007081208\\tools\\lib\\gcc\\arm-none-eabi\\7.3.1\\include\\stdarg.h"
	.byte	0x3
	.uleb128 0x28
	.uleb128 0x26
	.byte	0x7
	...
	.file 39 "d:\\da\\soft\\stm32cubeide_1.4.0\\stm32cubeide\\plugins\\com.st.stm32cube.ide.mcu.externaltools.gnu-tools-for-stm32.7-2018-q2-update.win32_1.4.0.202007081208\\tools\\arm-none-eabi\\include\\sys\\stdio.h"
	.byte	0x3
	.uleb128 0x4f
	.uleb128 0x27
	.byte	0x7
	...
	.byte	0x4
	.file 40 "d:\\da\\soft\\stm32cubeide_1.4.0\\stm32cubeide\\plugins\\com.st.stm32cube.ide.mcu.externaltools.gnu-tools-for-stm32.7-2018-q2-update.win32_1.4.0.202007081208\\tools\\arm-none-eabi\\include\\signal.h"
	.byte	0x3
	.uleb128 0x1d
	.uleb128 0x28
	.byte	0x5
	.uleb128 0x2
	.4byte	.LASF1106
	.file 41 "d:\\da\\soft\\stm32cubeide_1.4.0\\stm32cubeide\\plugins\\com.st.stm32cube.ide.mcu.externaltools.gnu-tools-for-stm32.7-2018-q2-update.win32_1.4.0.202007081208\\tools\\arm-none-eabi\\include\\sys\\signal.h"
	.byte	0x3
	.uleb128 0x6
	.uleb128 0x29
	.byte	0x7
	...
	.byte	0x4
	.file 42 "d:\\da\\soft\\stm32cubeide_1.4.0\\stm32cubeide\\plugins\\com.st.stm32cube.ide.mcu.externaltools.gnu-tools-for-stm32.7-2018-q2-update.win32_1.4.0.202007081208\\tools\\arm-none-eabi\\include\\sys\\time.h"
	.byte	0x3
	.uleb128 0x1f
	.uleb128 0x2a
	.byte	0x7
	.4byte	.Ldebug_macro43
	.file 43 "d:\\da\\soft\\stm32cubeide_1.4.0\\stm32cubeide\\plugins\\com.st.stm32cube.ide.mcu.externaltools.gnu-tools-for-stm32.7-2018-q2-update.win32_1.4.0.202007081208\\tools\\arm-none-eabi\\include\\machine\\_time.h"
	.byte	0x3
	.uleb128 0x12c
	.uleb128 0x2b
	.byte	0x4
