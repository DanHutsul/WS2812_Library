...
# 88 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_exti.c" 2
...
HAL_StatusTypeDef HAL_EXTI_SetConfigLine(EXTI_HandleTypeDef *hexti, EXTI_ConfigTypeDef *pExtiConfig)
{
  ...
  if ((hexti == 
# 150 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_exti.c" 3 4
               ((void *)0)
...
# 150 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_exti.c"
  ...
  if ((pExtiConfig->Line & (0x02uL << 24u)) != 0x00u)
  {
    ...
    {
      ((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->RTSR |= maskline;
    }
    else
    {
      ((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->RTSR &= ~maskline;
    ...
    {
      ((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->FTSR |= maskline;
    }
    else
    {
      ((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->FTSR &= ~maskline;
    ...
    if ((pExtiConfig->Line & ((0x04uL << 24u) | (0x02uL << 24u))) == ((0x04uL << 24u) | (0x02uL << 24u)))
    {
      ...
      regval = ((SYSCFG_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3800UL))->EXTICR[linepos >> 2u];
      regval &= ~((0xFUL << (0U)) << ((4U) * (linepos & 0x03u)));
      regval |= (pExtiConfig->GPIOSel << ((4U) * (linepos & 0x03u)));
      ((SYSCFG_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3800UL))->EXTICR[linepos >> 2u] = regval;
    }
  }
  ...
  {
    ((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->IMR |= maskline;
  }
  else
  {
    ((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->IMR &= ~maskline;
  ...
  {
    ((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->EMR |= maskline;
  }
  else
  {
    ((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->EMR &= ~maskline;
...
HAL_StatusTypeDef HAL_EXTI_GetConfigLine(EXTI_HandleTypeDef *hexti, EXTI_ConfigTypeDef *pExtiConfig)
{
  ...
  if ((hexti == 
# 245 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_exti.c" 3 4
               ((void *)0)
...
# 245 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_exti.c"
  ...
  if ((((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->IMR & maskline) != 0x00u)
  {
  ...
  if ((((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->EMR & maskline) != 0x00u)
  {
  ...
  if ((pExtiConfig->Line & (0x02uL << 24u)) != 0x00u)
  {
    ...
    if ((((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->RTSR & maskline) != 0x00u)
    {
    ...
    if ((((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->FTSR & maskline) != 0x00u)
    {
    ...
    if ((pExtiConfig->Line & ((0x04uL << 24u) | (0x02uL << 24u))) == ((0x04uL << 24u) | (0x02uL << 24u)))
    {
      ...
      regval = ((SYSCFG_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3800UL))->EXTICR[linepos >> 2u];
      pExtiConfig->GPIOSel = ((regval << ((4U) * (3uL - (linepos & 0x03u)))) >> 24);
    }
    else
    {
...
HAL_StatusTypeDef HAL_EXTI_ClearConfigLine(EXTI_HandleTypeDef *hexti)
{
  ...
  if (hexti == 
# 334 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_exti.c" 3 4
              ((void *)0)
# 334 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_exti.c"
  ...
  ((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->IMR = (((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->IMR & ~maskline);


  ((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->EMR = (((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->EMR & ~maskline);


  if ((hexti->Line & (0x02uL << 24u)) != 0x00u)
  {
    ((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->RTSR = (((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->RTSR & ~maskline);
    ((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->FTSR = (((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->FTSR & ~maskline);
...
# 380 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_exti.c"
HAL_StatusTypeDef HAL_EXTI_RegisterCallback(EXTI_HandleTypeDef *hexti, EXTI_CallbackIDTypeDef CallbackID, void (*pPendingCbfn)(void))
{
...
HAL_StatusTypeDef HAL_EXTI_GetHandle(EXTI_HandleTypeDef *hexti, uint32_t ExtiLine)
{
  ...
  if (hexti == 
# 411 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_exti.c" 3 4
              ((void *)0)
...
void HAL_EXTI_IRQHandler(EXTI_HandleTypeDef *hexti)
{
  ...
  regval = (((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->PR & maskline);
  if (regval != 0x00u)
  {

    ((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->PR = maskline;


    if (hexti->PendingCallback != 
# 461 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_exti.c" 3 4
                                 ((void *)0)
# 461 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_exti.c"
                                     )
    {
...
# 477 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_exti.c"
uint32_t HAL_EXTI_GetPending(EXTI_HandleTypeDef *hexti, uint32_t Edge)
{
  uint32_t regval;
  uint32_t linepos;
  ...
  regval = ((((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->PR & maskline) >> linepos);
  return regval;
}
# 506 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_exti.c"
void HAL_EXTI_ClearPending(EXTI_HandleTypeDef *hexti, uint32_t Edge)
{
  uint32_t maskline;
...
void HAL_EXTI_GenerateSWI(EXTI_HandleTypeDef *hexti)
{
  ...
  ((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->SWIER = maskline;
}
