...
# 50 "../Core/Src/system_stm32f4xx.c" 2
  ...
  switch (tmp)
  {
    ...
    case 0x08:
      ...
      if (pllsource != 0)
      {
        ...
        pllvco = (((uint32_t)8000000U) / pllm) * ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->PLLCFGR & (0x1FFUL << (6U))) >> 6);
      }
      else
      {

        pllvco = (((uint32_t)16000000U) / pllm) * ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->PLLCFGR & (0x1FFUL << (6U))) >> 6);
      }
