...
# 30 "../Middlewares/ST/STM32_USB_Host_Library/Core/Inc/usbh_ctlreq.h" 2
...
# 22 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_ctlreq.c" 2
...
USBH_StatusTypeDef USBH_Get_DevDesc(USBH_HandleTypeDef *phost, uint8_t length)
{
  ...
  if ((status = USBH_GetDescriptor(phost,
                                   0x00U | 0x00U,
                                   ((0x01U << 8) & 0xFF00U), phost->device.Data,
...
# 130 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_ctlreq.c"
...

{
  ...
  if ((status = USBH_GetDescriptor(phost, (0x00U | 0x00U),
                                   ((0x02U << 8) & 0xFF00U), pData, length)) == USBH_OK)
  {
                                      ...
                                      uint16_t length)
{
  ...
  {
    phost->Control.setup.b.bmRequestType = 0x80U | req_type;
    phost->Control.setup.b.bRequest = 0x06U;
    phost->Control.setup.b.wValue.w = value_idx;

    if ((value_idx & 0xff00U) == ((0x03U << 8) & 0xFF00U))
    {
                                   ...
                                   uint8_t DeviceAddress)
{
  if (phost->RequestState == CMD_SEND)
  {
    phost->Control.setup.b.bmRequestType = 0x00U | 0x00U |
                                           0x00U;

    phost->Control.setup.b.bRequest = 0x05U;
...
USBH_StatusTypeDef USBH_SetCfg(USBH_HandleTypeDef *phost, uint16_t cfg_idx)
{
  if (phost->RequestState == CMD_SEND)
  {
    ...
    phost->Control.setup.b.bRequest = 0x09U;
                                     ...
                                     uint8_t altSetting)
{
  if (phost->RequestState == CMD_SEND)
  {
    phost->Control.setup.b.bmRequestType = 0x00U | 0x01U
                                           | 0x00U;

    phost->Control.setup.b.bRequest = 0x0BU;
...
USBH_StatusTypeDef USBH_ClrFeature(USBH_HandleTypeDef *phost, uint8_t ep_num)
{
  if (phost->RequestState == CMD_SEND)
  {
    phost->Control.setup.b.bmRequestType = 0x00U | 0x02U
                                           | 0x00U;

    phost->Control.setup.b.bRequest = 0x01U;
    phost->Control.setup.b.wValue.w = 0x00U;
    phost->Control.setup.b.wIndex.w = ep_num;
    phost->Control.setup.b.wLength.w = 0U;
  }
  return USBH_CtlReq(phost, 0U, 0U);
}
# 346 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_ctlreq.c"
static void USBH_ParseDevDesc(USBH_DevDescTypeDef *dev_desc, uint8_t *buf,
                               uint16_t length)
{
  dev_desc->bLength = *(uint8_t *)(buf + 0);
  dev_desc->bDescriptorType = *(uint8_t *)(buf + 1);
  dev_desc->bcdUSB = (((uint16_t)(buf + 2)[0]) | ((uint16_t)(((uint32_t)(buf + 2)[1]) << 8)));
  ...
  if (length > 8U)
  {
    ...
    dev_desc->idVendor = (((uint16_t)(buf + 8)[0]) | ((uint16_t)(((uint32_t)(buf + 8)[1]) << 8)));
    dev_desc->idProduct = (((uint16_t)(buf + 10)[0]) | ((uint16_t)(((uint32_t)(buf + 10)[1]) << 8)));
    dev_desc->bcdDevice = (((uint16_t)(buf + 12)[0]) | ((uint16_t)(((uint32_t)(buf + 12)[1]) << 8)));
                              ...
                              uint16_t length)
{
  ...
  cfg_desc->wTotalLength = (((uint16_t)(buf + 2)[0]) | ((uint16_t)(((uint32_t)(buf + 2)[1]) << 8)));
  ...
  if (length > 0x09U)
  {
    ...
    while ((if_ix < 2U) && (ptr < cfg_desc->wTotalLength))
    {
      pdesc = USBH_GetNextDesc((uint8_t *)(void *)pdesc, &ptr);
      if (pdesc->bDescriptorType == 0x04U)
      {
        ...
        {
          pdesc = USBH_GetNextDesc((uint8_t *)(void *)pdesc, &ptr);
          if (pdesc->bDescriptorType == 0x05U)
          {
                              ...
                              uint8_t *buf)
{
  ...
  ep_descriptor->wMaxPacketSize = (((uint16_t)(buf + 4)[0]) | ((uint16_t)(((uint32_t)(buf + 4)[1]) << 8)));
  ep_descriptor->bInterval = *(uint8_t *)(buf + 6);
}
# 483 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_ctlreq.c"
static void USBH_ParseStringDesc(uint8_t *psrc, uint8_t *pdest, uint16_t length)
{
  uint16_t strlength;
  uint16_t idx;
# 495 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_ctlreq.c"
  if (psrc[1] == 0x03U)
  {
...
# 545 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_ctlreq.c"
USBH_StatusTypeDef USBH_CtlReq(USBH_HandleTypeDef *phost, uint8_t *buff,
                               uint16_t length)
{
  USBH_StatusTypeDef status;
  ...
  switch (phost->RequestState)
  {
    case CMD_SEND:
      ...
      status = USBH_BUSY;
# 569 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_ctlreq.c"
      break;
...
# 596 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_ctlreq.c"
      break;
...
static USBH_StatusTypeDef USBH_HandleControl(USBH_HandleTypeDef *phost)
{
  ...
  switch (phost->Control.state)
  {
    ...
    case CTRL_SETUP_WAIT:
      ...
      {
        direction = (phost->Control.setup.b.bmRequestType & 0x80U);
...
# 688 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_ctlreq.c"
    ...
    case CTRL_DATA_IN_WAIT:
      ...
      {
        phost->Control.state = CTRL_STATUS_OUT;
# 718 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_ctlreq.c"
      }
...
# 734 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_ctlreq.c"
      ...
      else
      {
        if (URB_Status == USBH_URB_ERROR)
        {
          ...
          phost->Control.state = CTRL_ERROR;
# 750 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_ctlreq.c"
        }
      }
      break;
...
# 811 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_ctlreq.c"
      ...
      else
      {
        if (URB_Status == USBH_URB_ERROR)
        {
          ...
          phost->Control.state = CTRL_ERROR;
          status = USBH_FAIL;
# 828 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_ctlreq.c"
        }
      }
      break;
...
# 859 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_ctlreq.c"
      ...
      {
        phost->Control.state = CTRL_ERROR;
# 872 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_ctlreq.c"
      }
      else
      {
        if (URB_Status == USBH_URB_STALL)
        {
          ...
          status = USBH_NOT_SUPPORTED;
# 888 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_ctlreq.c"
        }
      }
      break;
    ...
    case CTRL_STATUS_OUT_WAIT:
      ...
      if (URB_Status == USBH_URB_DONE)
      {
        status = USBH_OK;
        phost->Control.state = CTRL_COMPLETE;
# 914 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_ctlreq.c"
      }
      else if (URB_Status == USBH_URB_NOTREADY)
      {
        phost->Control.state = CTRL_STATUS_OUT;
# 927 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_ctlreq.c"
      }
      else
      {
        if (URB_Status == USBH_URB_ERROR)
        {
          phost->Control.state = CTRL_ERROR;
# 942 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_ctlreq.c"
        }
      }
      break;

    case CTRL_ERROR:
# 955 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_ctlreq.c"
      if (++phost->Control.errorcount <= 0x02U)
      {
