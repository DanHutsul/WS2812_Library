# 1 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_hcd.c"
...
#define DEBUG 1
# 1 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_hcd.c"
# 57 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_hcd.c"
...
# 58 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_hcd.c" 2
# 80 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_hcd.c"
static void HCD_HC_IN_IRQHandler(HCD_HandleTypeDef *hhcd, uint8_t chnum);
static void HCD_HC_OUT_IRQHandler(HCD_HandleTypeDef *hhcd, uint8_t chnum);
static void HCD_RXQLVL_IRQHandler(HCD_HandleTypeDef *hhcd);
static void HCD_Port_IRQHandler(HCD_HandleTypeDef *hhcd);
# 111 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_hcd.c"
HAL_StatusTypeDef HAL_HCD_Init(HCD_HandleTypeDef *hhcd)
{
  ...
  if (hhcd == 
# 116 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_hcd.c" 3 4
             ((void *)0)
# 116 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_hcd.c"
                 )
  {
    return HAL_ERROR;
  }
...
# 148 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_hcd.c"
  ...
  (void)USB_DisableGlobalInt ((hhcd)->Instance);
...
# 201 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_hcd.c"
                                  ...
                                  uint16_t mps)
{
  ...
  do{ if((hhcd)->Lock == HAL_LOCKED) { return HAL_BUSY; } else { (hhcd)->Lock = HAL_LOCKED; } }while (0U);
  ...
  status = USB_HC_Init(hhcd->Instance,
                        ...
                        ep_type,
                        mps);
  do{ (hhcd)->Lock = HAL_UNLOCKED; }while (0U);

  return status;
}
# 249 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_hcd.c"
HAL_StatusTypeDef HAL_HCD_HC_Halt(HCD_HandleTypeDef *hhcd, uint8_t ch_num)
{
...
HAL_StatusTypeDef HAL_HCD_DeInit(HCD_HandleTypeDef *hhcd)
{
  ...
  if (hhcd == 
# 268 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_hcd.c" 3 4
             ((void *)0)
# 268 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_hcd.c"
                 )
  {
    return HAL_ERROR;
  }
  ...
  hhcd->State = HAL_HCD_STATE_BUSY;
# 285 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_hcd.c"
...
# 367 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_hcd.c"
                                           ...
                                           uint8_t do_ping)
{
  ...
  if (token == 0U)
  {
    hhcd->hc[ch_num].data_pid = 3U;
    hhcd->hc[ch_num].do_ping = do_ping;
  }
  else
  {
    hhcd->hc[ch_num].data_pid = 2U;
  }
...
void HAL_HCD_IRQHandler(HCD_HandleTypeDef *hhcd)
{
  ...
  if (USB_GetMode(hhcd->Instance) == 1U)
  {

    if ((USB_ReadInterrupts((hhcd)->Instance) == 0U))
    {
      return;
    }

    if (((USB_ReadInterrupts((hhcd)->Instance) & ((0x1UL << (21U)))) == ((0x1UL << (21U)))))
    {

      (((hhcd)->Instance->GINTSTS) = ((0x1UL << (21U))));
    }

    if (((USB_ReadInterrupts((hhcd)->Instance) & ((0x1UL << (20U)))) == ((0x1UL << (20U)))))
    {

      (((hhcd)->Instance->GINTSTS) = ((0x1UL << (20U))));
    }

    if (((USB_ReadInterrupts((hhcd)->Instance) & ((0x1UL << (26U)))) == ((0x1UL << (26U)))))
    {

      (((hhcd)->Instance->GINTSTS) = ((0x1UL << (26U))));
    }

    if (((USB_ReadInterrupts((hhcd)->Instance) & ((0x1UL << (1U)))) == ((0x1UL << (1U)))))
    {

      (((hhcd)->Instance->GINTSTS) = ((0x1UL << (1U))));
    }


    if (((USB_ReadInterrupts((hhcd)->Instance) & ((0x1UL << (29U)))) == ((0x1UL << (29U)))))
    {
      (((hhcd)->Instance->GINTSTS) = ((0x1UL << (29U))));

      if ((*(volatile uint32_t *)((uint32_t)USBx_BASE + 0x440UL) & (0x1UL << (0U))) == 0U)
      {
        ...
        (void)USB_InitFSLSPClkSel(hhcd->Instance, 1U);
      }
    }


    if (((USB_ReadInterrupts((hhcd)->Instance) & ((0x1UL << (24U)))) == ((0x1UL << (24U)))))
    {
      HCD_Port_IRQHandler(hhcd);
    }


    if (((USB_ReadInterrupts((hhcd)->Instance) & ((0x1UL << (3U)))) == ((0x1UL << (3U)))))
    {
      ...
      (((hhcd)->Instance->GINTSTS) = ((0x1UL << (3U))));
    }


    if (((USB_ReadInterrupts((hhcd)->Instance) & ((0x1UL << (25U)))) == ((0x1UL << (25U)))))
    {
      ...
      for (i = 0U; i < hhcd->Init.Host_channels; i++)
      {
        ...
        {
          if ((((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((i) * 0x20UL)))->HCCHAR & (0x1UL << (15U))) == (0x1UL << (15U)))
          {
      ...
      (((hhcd)->Instance->GINTSTS) = ((0x1UL << (25U))));
    }


    if ((((USB_ReadInterrupts((hhcd)->Instance) & ((0x1UL << (4U)))) == ((0x1UL << (4U))))) != 0U)
    {
      ((hhcd->Instance)->GINTMSK &= ~((0x1UL << (4U))));
...
__attribute__((weak)) void HAL_HCD_PortEnabled_Callback(HCD_HandleTypeDef *hhcd)
{
...
__attribute__((weak)) void HAL_HCD_PortDisabled_Callback(HCD_HandleTypeDef *hhcd)
{
...
# 704 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_hcd.c"
...
# 1019 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_hcd.c"
HAL_StatusTypeDef HAL_HCD_Start(HCD_HandleTypeDef *hhcd)
{
  do{ if((hhcd)->Lock == HAL_LOCKED) { return HAL_BUSY; } else { (hhcd)->Lock = HAL_LOCKED; } }while (0U);
  (void)USB_EnableGlobalInt ((hhcd)->Instance);
...
# 1078 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_hcd.c"
HCD_StateTypeDef HAL_HCD_GetState(HCD_HandleTypeDef *hhcd)
{
  return hhcd->State;
}
# 1097 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_hcd.c"
HCD_URBStateTypeDef HAL_HCD_HC_GetURBState(HCD_HandleTypeDef *hhcd, uint8_t chnum)
{
  return hhcd->hc[chnum].urb_state;
}
# 1110 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_hcd.c"
uint32_t HAL_HCD_HC_GetXferCount(HCD_HandleTypeDef *hhcd, uint8_t chnum)
{
  return hhcd->hc[chnum].xfer_count;
}
# 1132 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_hcd.c"
HCD_HCStateTypeDef HAL_HCD_HC_GetState(HCD_HandleTypeDef *hhcd, uint8_t chnum)
{
...
# 1175 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_hcd.c"
static void HCD_HC_IN_IRQHandler(HCD_HandleTypeDef *hhcd, uint8_t chnum)
{
  USB_OTG_GlobalTypeDef *USBx = hhcd->Instance;
  uint32_t USBx_BASE = (uint32_t)USBx;
  ...
  if ((((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((ch_num) * 0x20UL)))->HCINT & (0x1UL << (2U))) == (0x1UL << (2U)))
  {
    (((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((ch_num) * 0x20UL)))->HCINT = ((0x1UL << (2U))));
    (((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((ch_num) * 0x20UL)))->HCINTMSK |= (0x1UL << (1U)));
  }
  else if ((((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((ch_num) * 0x20UL)))->HCINT & (0x1UL << (8U))) == (0x1UL << (8U)))
  {
    (((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((ch_num) * 0x20UL)))->HCINT = ((0x1UL << (8U))));
    hhcd->hc[ch_num].state = HC_BBLERR;
    (((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((ch_num) * 0x20UL)))->HCINTMSK |= (0x1UL << (1U)));
    (void)USB_HC_Halt(hhcd->Instance, (uint8_t)ch_num);
  }
  else if ((((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((ch_num) * 0x20UL)))->HCINT & (0x1UL << (5U))) == (0x1UL << (5U)))
  {
    (((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((ch_num) * 0x20UL)))->HCINT = ((0x1UL << (5U))));
  }
  else if ((((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((ch_num) * 0x20UL)))->HCINT & (0x1UL << (3U))) == (0x1UL << (3U)))
  {
    (((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((ch_num) * 0x20UL)))->HCINTMSK |= (0x1UL << (1U)));
    hhcd->hc[ch_num].state = HC_STALL;
    (((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((ch_num) * 0x20UL)))->HCINT = ((0x1UL << (4U))));
    (((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((ch_num) * 0x20UL)))->HCINT = ((0x1UL << (3U))));
    (void)USB_HC_Halt(hhcd->Instance, (uint8_t)ch_num);
  }
  else if ((((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((ch_num) * 0x20UL)))->HCINT & (0x1UL << (10U))) == (0x1UL << (10U)))
  {
    (((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((ch_num) * 0x20UL)))->HCINTMSK |= (0x1UL << (1U)));
    (void)USB_HC_Halt(hhcd->Instance, (uint8_t)ch_num);
    (((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((ch_num) * 0x20UL)))->HCINT = ((0x1UL << (4U))));
    hhcd->hc[ch_num].state = HC_DATATGLERR;
    (((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((ch_num) * 0x20UL)))->HCINT = ((0x1UL << (10U))));
  }
  else
  {
  ...
  if ((((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((ch_num) * 0x20UL)))->HCINT & (0x1UL << (9U))) == (0x1UL << (9U)))
  {
    (((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((ch_num) * 0x20UL)))->HCINTMSK |= (0x1UL << (1U)));
    (void)USB_HC_Halt(hhcd->Instance, (uint8_t)ch_num);
    (((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((ch_num) * 0x20UL)))->HCINT = ((0x1UL << (9U))));
  }
  else if ((((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((ch_num) * 0x20UL)))->HCINT & (0x1UL << (0U))) == (0x1UL << (0U)))
  {
    if (hhcd->Init.dma_enable != 0U)
    {
      hhcd->hc[ch_num].xfer_count = hhcd->hc[ch_num].xfer_len -
                                    (((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((ch_num) * 0x20UL)))->HCTSIZ & (0x7FFFFUL << (0U)));
    }

    hhcd->hc[ch_num].state = HC_XFRC;
    hhcd->hc[ch_num].ErrCnt = 0U;
    (((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((ch_num) * 0x20UL)))->HCINT = ((0x1UL << (0U))));

    if ((hhcd->hc[ch_num].ep_type == 0U) ||
        (hhcd->hc[ch_num].ep_type == 2U))
    {
      (((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((ch_num) * 0x20UL)))->HCINTMSK |= (0x1UL << (1U)));
      (void)USB_HC_Halt(hhcd->Instance, (uint8_t)ch_num);
      (((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((ch_num) * 0x20UL)))->HCINT = ((0x1UL << (4U))));
    }
    else if (hhcd->hc[ch_num].ep_type == 3U)
    {
    ...
    else if (hhcd->hc[ch_num].ep_type == 1U)
    {
      hhcd->hc[ch_num].urb_state = URB_DONE;
  ...
  else if ((((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((ch_num) * 0x20UL)))->HCINT & (0x1UL << (1U))) == (0x1UL << (1U)))
  {
    (((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((ch_num) * 0x20UL)))->HCINTMSK &= ~(0x1UL << (1U)));
    ...
    (((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((ch_num) * 0x20UL)))->HCINT = ((0x1UL << (1U))));
    HAL_HCD_HC_NotifyURBChange_Callback(hhcd, (uint8_t)ch_num, hhcd->hc[ch_num].urb_state);
  }
  else if ((((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((ch_num) * 0x20UL)))->HCINT & (0x1UL << (7U))) == (0x1UL << (7U)))
  {
    (((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((ch_num) * 0x20UL)))->HCINTMSK |= (0x1UL << (1U)));
    hhcd->hc[ch_num].ErrCnt++;
    hhcd->hc[ch_num].state = HC_XACTERR;
    (void)USB_HC_Halt(hhcd->Instance, (uint8_t)ch_num);
    (((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((ch_num) * 0x20UL)))->HCINT = ((0x1UL << (7U))));
  }
  else if ((((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((ch_num) * 0x20UL)))->HCINT & (0x1UL << (4U))) == (0x1UL << (4U)))
  {
    if (hhcd->hc[ch_num].ep_type == 3U)
    {
      hhcd->hc[ch_num].ErrCnt = 0U;
      (((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((ch_num) * 0x20UL)))->HCINTMSK |= (0x1UL << (1U)));
      (void)USB_HC_Halt(hhcd->Instance, (uint8_t)ch_num);
    }
    else if ((hhcd->hc[ch_num].ep_type == 0U) ||
             (hhcd->hc[ch_num].ep_type == 2U))
    {
      hhcd->hc[ch_num].ErrCnt = 0U;
...
# 1374 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_hcd.c"
static void HCD_HC_OUT_IRQHandler(HCD_HandleTypeDef *hhcd, uint8_t chnum)
{
  USB_OTG_GlobalTypeDef *USBx = hhcd->Instance;
  uint32_t USBx_BASE = (uint32_t)USBx;
  ...
  else if ((((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((ch_num) * 0x20UL)))->HCINT & (0x1UL << (6U))) == (0x1UL << (6U)))
  {
    ...
    (((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((ch_num) * 0x20UL)))->HCINTMSK |= (0x1UL << (1U)));
    (void)USB_HC_Halt(hhcd->Instance, (uint8_t)ch_num);
    (((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((ch_num) * 0x20UL)))->HCINT = ((0x1UL << (6U))));
  }
  else if ((((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((ch_num) * 0x20UL)))->HCINT & (0x1UL << (9U))) == (0x1UL << (9U)))
  {
    (((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((ch_num) * 0x20UL)))->HCINTMSK |= (0x1UL << (1U)));
    (void)USB_HC_Halt(hhcd->Instance, (uint8_t)ch_num);
    (((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((ch_num) * 0x20UL)))->HCINT = ((0x1UL << (9U))));
  ...
  else if ((((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((ch_num) * 0x20UL)))->HCINT & (0x1UL << (1U))) == (0x1UL << (1U)))
  {
    ...
    {
      hhcd->hc[ch_num].urb_state = URB_DONE;
      if ((hhcd->hc[ch_num].ep_type == 2U) ||
          (hhcd->hc[ch_num].ep_type == 3U))
      {
        hhcd->hc[ch_num].toggle_out ^= 1U;
      }
    }
...
static void HCD_RXQLVL_IRQHandler(HCD_HandleTypeDef *hhcd)
{
  ...
  ch_num = temp & (0xFUL << (0U));
  pktsts = (temp & (0xFUL << (17U))) >> 17;
  pktcnt = (temp & (0x7FFUL << (4U))) >> 4;
  ...
  switch (pktsts)
  {
    case 2U:
      ...
      if ((pktcnt > 0U) && (hhcd->hc[ch_num].xfer_buff != (void *)0))
      {
        ...
        if ((((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((ch_num) * 0x20UL)))->HCTSIZ & (0x3FFUL << (19U))) > 0U)
        {
...
static void HCD_Port_IRQHandler(HCD_HandleTypeDef *hhcd)
{
  ...
  hprt0_dup = *(volatile uint32_t *)((uint32_t)USBx_BASE + 0x440UL);

  hprt0_dup &= ~((0x1UL << (2U)) | (0x1UL << (1U)) |
                 (0x1UL << (3U)) | (0x1UL << (5U)));


  if ((hprt0 & (0x1UL << (1U))) == (0x1UL << (1U)))
  {
    if ((hprt0 & (0x1UL << (0U))) == (0x1UL << (0U)))
    {
  ...
  if ((hprt0 & (0x1UL << (3U))) == (0x1UL << (3U)))
  {
    hprt0_dup |= (0x1UL << (3U));

    if ((hprt0 & (0x1UL << (2U))) == (0x1UL << (2U)))
    {
      if (hhcd->Init.phy_itface == 2U)
      {
        if ((hprt0 & (0x3UL << (17U))) == (2U << 17))
        {
          (void)USB_InitFSLSPClkSel(hhcd->Instance, 2U);
        }
        else
        {
          (void)USB_InitFSLSPClkSel(hhcd->Instance, 1U);
      ...
      {
        if (hhcd->Init.speed == 1U)
        {
          ((USB_OTG_HostTypeDef *)(USBx_BASE + 0x400UL))->HFIR = 60000U;
        }
      }
  ...
  if ((hprt0 & (0x1UL << (5U))) == (0x1UL << (5U)))
  {
    hprt0_dup |= (0x1UL << (5U));
  }


  *(volatile uint32_t *)((uint32_t)USBx_BASE + 0x440UL) = hprt0_dup;
}
