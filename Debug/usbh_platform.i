# 1 "../USB_HOST/Target/usbh_platform.c"
...
# 24 "../USB_HOST/Target/usbh_platform.c" 2
...
void MX_DriverVbusFS(uint8_t state)
{
  ...
  HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0800UL)),((uint16_t)0x0001),(GPIO_PinState)data);
}
