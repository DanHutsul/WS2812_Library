...
#define DEBUG 1
# 1 "../USB_HOST/Target/usbh_conf.c"
# 23 "../USB_HOST/Target/usbh_conf.c"
...
# 24 "../USB_HOST/Target/usbh_conf.c" 2
# 1 "../USB_HOST/Target/usbh_platform.h" 1
# 23 "../USB_HOST/Target/usbh_platform.h"
...
# 31 "../USB_HOST/Target/usbh_platform.h" 2
...
# 25 "../USB_HOST/Target/usbh_conf.c" 2
# 39 "../USB_HOST/Target/usbh_conf.c"
...
# 63 "../USB_HOST/Target/usbh_conf.c"
void HAL_HCD_MspInit(HCD_HandleTypeDef* hcdHandle)
{
  GPIO_InitTypeDef GPIO_InitStruct = {0};
  if(hcdHandle->Instance==((USB_OTG_GlobalTypeDef *) 0x50000000UL))
  {
    ...
    do {(((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->AHB2ENR |= ((0x1UL << (7U)))); do { volatile uint32_t tmpreg = 0x00U; ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB2ENR) |= ((0x1UL << (14U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB2ENR) & ((0x1UL << (14U)))); (void)tmpreg; } while(0U); }while(0U);
...
void HAL_HCD_MspDeInit(HCD_HandleTypeDef* hcdHandle)
{
  if(hcdHandle->Instance==((USB_OTG_GlobalTypeDef *) 0x50000000UL))
  {
    ...
    HAL_GPIO_DeInit(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0000UL)), ((uint16_t)0x0200)|((uint16_t)0x0400)|((uint16_t)0x0800)|((uint16_t)0x1000));
...
USBH_StatusTypeDef USBH_LL_Init(USBH_HandleTypeDef *phost)
{
  ...
  hhcd_USB_OTG_FS.Instance = ((USB_OTG_GlobalTypeDef *) 0x50000000UL);
  hhcd_USB_OTG_FS.Init.Host_channels = 8;
  hhcd_USB_OTG_FS.Init.speed = 1U;
  hhcd_USB_OTG_FS.Init.dma_enable = DISABLE;
  hhcd_USB_OTG_FS.Init.phy_itface = 2U;
...
# 435 "../USB_HOST/Target/usbh_conf.c"
