...
# 11 "d:\\da\\soft\\stm32cubeide_1.4.0\\stm32cubeide\\plugins\\com.st.stm32cube.ide.mcu.externaltools.gnu-tools-for-stm32.7-2018-q2-update.win32_1.4.0.202007081208\\tools\\arm-none-eabi\\include\\string.h" 2 3
...
# 12 "d:\\da\\soft\\stm32cubeide_1.4.0\\stm32cubeide\\plugins\\com.st.stm32cube.ide.mcu.externaltools.gnu-tools-for-stm32.7-2018-q2-update.win32_1.4.0.202007081208\\tools\\arm-none-eabi\\include\\string.h" 2 3
...
# 13 "d:\\da\\soft\\stm32cubeide_1.4.0\\stm32cubeide\\plugins\\com.st.stm32cube.ide.mcu.externaltools.gnu-tools-for-stm32.7-2018-q2-update.win32_1.4.0.202007081208\\tools\\arm-none-eabi\\include\\string.h" 2 3
...
extern uint16_t BUF_DMA [50 + 10*24];
...
inline void __attribute__((always_inline)) udelay_asm (uint32_t useconds) {
...
void light_strip(int* data) {
 ...
 for(size_t i = 0; i<data_size; ++i){
   if(data[i] == 0){
    ((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0C00UL))->BSRR = (1<<11);
    udelay_asm(7);
    ((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0C00UL))->BSRR = (1<< (11 + 16) );
    udelay_asm(9);
   } else{
    ((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0C00UL))->BSRR = (1<<11);
    udelay_asm(16);
...
void SystemClock_Config(void)
{
  ...
  PeriphClkInitStruct.PeriphClockSelection = 0x00000001U;
...
{
# 356 "../Core/Src/main.c"
  hi2s2.Instance = ((SPI_TypeDef *) (0x40000000UL + 0x3800UL));
  hi2s2.Init.Mode = ((0x2UL << (8U)));
  hi2s2.Init.Standard = (0x00000000U);
  hi2s2.Init.DataFormat = (0x00000000U);
  hi2s2.Init.MCLKOutput = (0x00000000U);
  hi2s2.Init.AudioFreq = (96000U);
  hi2s2.Init.CPOL = (0x00000000U);
  hi2s2.Init.ClockSource = (0x00000000U);
  hi2s2.Init.FullDuplexMode = (0x00000001U);
...
{
# 390 "../Core/Src/main.c"
  hi2s3.Instance = ((SPI_TypeDef *) (0x40000000UL + 0x3C00UL));
  hi2s3.Init.Mode = ((0x2UL << (8U)));
  hi2s3.Init.Standard = (0x00000000U);
  hi2s3.Init.DataFormat = (0x00000000U);
  hi2s3.Init.MCLKOutput = ((0x1UL << (9U)));
  hi2s3.Init.AudioFreq = (96000U);
  hi2s3.Init.CPOL = (0x00000000U);
  hi2s3.Init.ClockSource = (0x00000000U);
  hi2s3.Init.FullDuplexMode = (0x00000000U);
...
# 425 "../Core/Src/main.c"
  ...
  hspi1.Init.DataSize = (0x00000000U);
  hspi1.Init.CLKPolarity = (0x00000000U);
  hspi1.Init.CLKPhase = (0x00000000U);
  hspi1.Init.NSS = (0x1UL << (9U));
  hspi1.Init.BaudRatePrescaler = (0x00000000U);
  hspi1.Init.FirstBit = (0x00000000U);
  hspi1.Init.TIMode = (0x00000000U);
  hspi1.Init.CRCCalculation = (0x00000000U);
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1000UL)), ((uint16_t)0x0008), GPIO_PIN_RESET);


  HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0800UL)), ((uint16_t)0x0001), GPIO_PIN_SET);
  ...
  HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0C00UL)), ((uint16_t)0x0800)|((uint16_t)0x1000)|((uint16_t)0x2000)|((uint16_t)0x4000)
                          |((uint16_t)0x8000)|((uint16_t)0x0010), GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = ((uint16_t)0x0010)|((uint16_t)0x0020)|((uint16_t)0x0002);
  GPIO_InitStruct.Mode = 0x10120000U;
  GPIO_InitStruct.Pull = 0x00000000U;
  HAL_GPIO_Init(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1000UL)), &GPIO_InitStruct);
